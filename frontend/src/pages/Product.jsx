...
const Product = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{productData ? `${productData.name} | Sunubio & Co` : "Produit bio introuvable"}</title>
        <meta name="description" content={productData ? productData.description.slice(0, 160) : "Produit bio, naturel et certifié sur Sunubio & Co."} />
        <meta property="og:title" content={productData ? productData.name : "Produit bio introuvable"} />
        <meta property="og:description" content={productData ? productData.description.slice(0, 160) : "Produit bio, naturel et certifié sur Sunubio & Co."} />
          ...
          {JSON.stringify({
            ...
            "aggregateRating": productData.reviews?.length
              ? {
                  ...
                  "ratingValue": (
                    productData.reviews.reduce((acc, r) => acc + Number(r.rating), 0) /
